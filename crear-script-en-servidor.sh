#!/bin/bash
# Este script crea setup-postgresql.sh directamente en el servidor
# Copia y pega TODO este contenido en el servidor y ejecuta: bash crear-script-en-servidor.sh

cat > /var/www/p2prsc-backend/setup-postgresql.sh << 'SCRIPT_END'
#!/bin/bash
...
chmod +x /var/www/p2prsc-backend/setup-postgresql.sh
echo "✓ Script creado en /var/www/p2prsc-backend/setup-postgresql.sh"
echo "Ahora ejecuta: ./setup-postgresql.sh"
